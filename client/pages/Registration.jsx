...
function Registration({ userInfo, setUserInfo }) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      let response = await axios.post('/api/register', userInfo); // response only has status 200, no data (JSON)
  ...
  return (
    <div className="registration-container">
      <h3>Registration</h3>
      <br></br>
      {/* Invoking redirect hook in event of successful registration */}
